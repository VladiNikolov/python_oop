...
class TestHero(TestCase):
    ...
    def test_battle_when_hero_is_the_same_as_enemy_raise_exception(self):
    ...
    def test_fight_with_zero_hero_health_raise_value_error(self):
        self.hero.health = 0
    ...
    def test_fight_with_zero_enemy_health_raise_value_error(self):
        self.enemy.health = 0
    ...
    def test_battle_hero_and_lose_expect_stats_improve(self):
